...
class SecurityMasterRequestApproved extends Mailable
{
    ...
    {
        return new Envelope(
            subject: "Security Master Request Approved - " . config('app.name'),
        );
    }
    ...
    {
        return new Content(
            view: 'emails.security-master-request-approved',
        );
    }
